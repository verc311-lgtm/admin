  ...
  return (
    <div className="space-y-6 md:space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
        {stats.map((stat, i) => (
          <div key={i} className={`bg-white p-5 md:p-10 rounded-[2rem] md:rounded-[3rem] shadow-sm border-2 ${stat.border} flex flex-col gap-3 md:gap-6 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group`}>
            <div className={`${stat.bg} ${stat.color} w-10 h-10 md:w-16 md:h-16 rounded-xl md:rounded-[1.5rem] flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0`}>
            ...
            <div>
              ...
              <p className="text-xl md:text-3xl font-black text-[#0a192f] leading-none italic tracking-tighter">{stat.value}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-10">
        <div className="lg:col-span-2 bg-white p-6 md:p-12 rounded-[2rem] md:rounded-[4rem] shadow-sm border border-slate-100 flex flex-col">
        ...
        <div className="bg-[#0a192f] p-6 md:p-12 rounded-[2rem] md:rounded-[4rem] shadow-2xl flex flex-col relative overflow-hidden ring-4 md:ring-8 ring-white">
